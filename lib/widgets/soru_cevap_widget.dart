...
class QuizQuestionWidget extends StatefulWidget {
  const QuizQuestionWidget({super.key, required this.text, required this.categoryName, required this.icon});
      final String text;
...
class _QuizQuestionWidgetState extends State<QuizQuestionWidget> {
  ...
  Widget build(BuildContext context) {
    if (isLoading) {
      return SizedBox(height: 500, width: 300,child: Center(child: Lottie.asset("assets/lottie/lot_loading02.json")),);
    }
